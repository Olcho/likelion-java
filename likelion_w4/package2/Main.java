...
public class Main {
    ...
    private static final Map<String, List<Role>> partMap = new HashMap<>();
    ...
    private static void addToMap(Role member) {
    ...
    private static void searchByPart() {
        ...
        String part = inputText("조회할 파트: ");

        List<Role> list = partMap.get(part);
